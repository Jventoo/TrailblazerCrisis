...
#include "TCCharacterAnimInstance.generated.h"
...
class HORIZONSTC_API UTCCharacterAnimInstance : public UAnimInstance
{
	GENERATED_BODY()
...
private:
	...
	EMovementDirection CalculateQuadrant(EMovementDirection Current, float FRThreshold, float FLThreshold, float BRThreshold,
...
public:
	...
	ATCBaseCharacter* Character = nullptr;
