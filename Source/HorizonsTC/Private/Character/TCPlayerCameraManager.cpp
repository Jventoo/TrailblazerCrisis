...
ATCPlayerCameraManager::ATCPlayerCameraManager()
{
...
void ATCPlayerCameraManager::OnPossess(ATCBaseCharacter* NewCharacter)
{
	...
	UTCPlayerCameraBehavior* CastedBehv = Cast<UTCPlayerCameraBehavior>(CameraBehavior->GetAnimInstance());
	if (CastedBehv)
	{
...
float ATCPlayerCameraManager::GetCameraBehaviorParam(FName CurveName)
{
...
void ATCPlayerCameraManager::UpdateViewTargetInternal(FTViewTarget& OutVT, float DeltaTime)
{
...
FVector ATCPlayerCameraManager::CalculateAxisIndependentLag(FVector CurrentLocation, FVector TargetLocation,
...
bool ATCPlayerCameraManager::CustomCameraBehavior(float DeltaTime, FVector& Location, FRotator& Rotation, float& FOV)
{
